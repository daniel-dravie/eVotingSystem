      ...
      const votePromises = Object.entries(selectedVotes).map(
        async ([portfolio, candidate]) => {
          if (candidate.vote === "yes") {
            ...
            // Set total votes as currentVotes + 1
